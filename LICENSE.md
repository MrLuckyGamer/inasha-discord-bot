...
You are granted permission to use this software **only by inviting the bot to your Discord server, or using the app commands**.
...
- Claim ownership of the software or derivatives  
